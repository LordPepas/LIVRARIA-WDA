...
$sql_ultimo_aluguel =  "SELECT a.Cod_aluguel, l.Nome_livro, u.Nome_usuario, a.Data_aluguel, a.Data_previsão, a.Quantidade_alugada
FROM aluguel a
INNER JOIN livro l ON a.Livro = l.Cod_livro
INNER JOIN usuario u ON a.Usuário = u.Cod_usuario 
ORDER BY a.Cod_aluguel DESC";
$resultado_ultimo_aluguel = $conexao->query($sql_ultimo_aluguel);

if ($resultado_ultimo_aluguel->num_rows >= 1) {
  // buscar a primeira linha do conjunto de resultados
  $linha_ultimo_aluguel = $resultado_ultimo_aluguel->fetch_assoc();
  
  // verificar se a consulta retornou uma linha válida
  if ($linha_ultimo_aluguel !== null) {
    // gerar a string de informações do aluguel
...
if ($linha_total_alugueis['total_alugueis'] == 0) {
  $quantidade_alugueis = "Não há aluguéis registrados!";
}
//Total de livros
...
if ($linha_total_livros['Nome_livro'] == 0) {
  $total_livros = "Não há livros registrados!";
}
  ...
  <div class="boxes">
    ...
    <div class="box box2">
      <a href="./Livros.php" style="text-decoration: none;">
        ...
        <span class="text">Total de livros disponíveis:</span>
    ...
    <div class="box box2">
      <a href="./Aluguel.php" style="text-decoration: none;">
        ...
        <span class="text">Total de alugueis Ativos::</span>
...
<script>
  ...
  // Verifica se a largura da janela é menor que 700px
