...
if (!empty($_GET['search'])) {
    ...
    $sql = "SELECT a.Cod_aluguel,l.Nome_livro,usuario.u.Nome_usuario,a.Data_aluguel,a.Data_previsão,a.Quantidade_alugada
    FROM a
    INNER JOIN livro l ON a.Livro = l.Cod_livro
    INNER JOIN usuario u ON a.Usuário = u.Cod_usuario AND (a.Cod_aluguel LIKE '%$data%' or l.Nome_livro LIKE 
    '%$data%' or u.Nome_usuario LIKE '%$data%' or a.Data_aluguel LIKE '%$data%' or a.Data_previsão LIKE '%$data%')
     ORDER BY a.Cod_aluguel DESC";
} else {
    $sql = "SELECT a.Cod_aluguel, l.Nome_livro, u.Nome_usuario, a.Data_aluguel, a.Data_previsão, a.Quantidade_alugada
FROM aluguel a
INNER JOIN livro l ON a.Livro = l.Cod_livro
