            ...
            <tbody>
                ...
                while ($aluguel_data = mysqli_fetch_assoc($resultadoConsulta)) {
                    ...
                    if (strtotime($aluguel_data['Data_previsão']) >= strtotime(date('Y-m-d'))) {
                        $sqlstatus = "UPDATE aluguel SET Status_aluguel = 'Livro no Prazo' WHERE Cod_aluguel = $aluguel_data[Cod_aluguel]";
                        ...
                        $sqlstatus = "UPDATE aluguel SET Status_aluguel = 'Livro  Prazo' WHERE Cod_aluguel = $aluguel_data[Cod_aluguel]";
                        $status = $conexao->query($sqlstatus);
                        echo "<td>
