...
// Converter esses objetos em uma string JSON
  ...
  <div class="boxes">
    <div class="box box1">
      <a href="./Aluguel.php" style="text-decoration: none;">
        <img src="../assets/img/ultimo.png" width="76" height="76"><br>
    ...
    <div class="box box2">
      <a href="./Livros.php" style="text-decoration: none;">
        <img src="../assets/img/estante.png" width="76" height="76"><br>
    ...
    <div class="box box2">
      <a href="./Aluguel.php" style="text-decoration: none;">
        <img src="../assets/img/ativo.png" width="76" height="76"><br>
    ...
    <div class="box box2">
      <a href="./Livros.php" style="text-decoration: none;">
        <img src="../assets/img/quantidade.jpg" width="76" height="76"><br>
    ...
    <div class="box box1">
      <a href="./Historico.php" style="text-decoration: none;">
        <img src="../assets/img/ultimod.png" width="76" height="76"><br>
    ...
    <div class="box box2">
      <a href="./Historico.php" style="text-decoration: none;">
        <img src="../assets/img/noprazo.png" width="56" height="56"><br>
    ...
    <div class="box box2">
      <a href="./Historico.php" style="text-decoration: none;">
        <img src="../assets/img/atraso.png" width="56" height="56"><br>
