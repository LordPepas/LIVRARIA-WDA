...
if (!empty($_GET['search'])) {
    ...
    $sqlsearch = "SELECT * FROM usuario WHERE Cod_usuario LIKE '%$search%' or Nome_usuario LIKE '%$search%' or Cidade LIKE '%$search%' or Endereço LIKE '%$search%' or Email LIKE '%$search%'  ORDER BY Cod_usuario DESC";
} else {
    $sqlsearch = "SELECT * FROM usuario ORDER BY Cod_usuario DESC"; // Initialize the variable if search is empty
}
...
// Calcula o total de registros e páginas
$totalRegistros = $result->num_rows;
$totalPaginas = ceil($totalRegistros / $registrosPorPagina);

// Obtem os registros da página atual
if (!empty($search)) {
    $sqlsearch .= " LIMIT $offset, $registrosPorPagina";
    $result = $conexao->query($sqlsearch);
} else {
    $sqluser = "SELECT * FROM usuario ORDER BY Cod_usuario DESC";
    $sqluser .= " LIMIT $offset, $registrosPorPagina";
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="Usuarios.php?pagina=1" style="text-decoration:underline">CLIENTES</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="table-responsive">
        <div class="header-table d-flex justify-content-between align-items-center">
            ...
            <a href="../CREATE/C_usuario.php" class="btn btn-success btn-sm">ADICIONAR+</a><br>
            <!-- Campo de busca -->
        ...
        <div class="pagination <?php if (!empty($search)) echo 'd-none'; ?>">
            ...
            <ul class="pagination">
                <li class="page-item <?php echo ($paginaAtual == 1) ? 'disabled' : ''; ?>">
                    <a class="page-link" href="Usuarios.php?pagina=<?php echo ($paginaAtual - 1); ?>" aria-label="Anterior">
                ...
                if ($paginaAtual > 3) {
                    echo "<li class='page-item'><a class='page-link' href='Usuarios.php?pagina=1'>1</a></li>";
                    echo "<li class='page-item disabled'><span class='page-link'>...</span></li>";
                }

                // Exibir páginas anteriores à página atual
                for ($i = max(1, $paginaAtual - 1); $i < $paginaAtual; $i++) {
                    echo "<li class='page-item'><a class='page-link' href='Usuarios.php?pagina=$i'>$i</a></li>";
                }
                ...
                if ($paginaAtual < $totalPaginas - 2) {
                    echo "<li class='page-item disabled'><span class='page-link'>...</span></li>";
                    echo "<li class='page-item'><a class='page-link' href='Usuarios.php?pagina=$totalPaginas'>$totalPaginas</a></li>";
                }
                ?>
                <li class="page-item <?php echo ($paginaAtual == $totalPaginas) ? 'disabled' : ''; ?>">
                    <a class="page-link" href="Usuarios.php?pagina=<?php echo ($paginaAtual + 1); ?>" aria-label="Próxima">
        ...
        $('.clickable-td').click(function() {
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    // Lida com erros de solicitação, se houver
                    console.log(error);
                }
            });
        });
